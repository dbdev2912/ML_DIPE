export default [
    { id: 0, name: "Tiny Int", type: "int", range: { min: -128, max: 127 } },
    { id: 1, name: "Tiny Int Unsigned", type: "int", range: { min: 0, max: 255 } },
    { id: 2, name: "Small Int", type: "int", range: { min: -32768, max: 32767 } },
    { id: 3, name: "Small Int Unsigned", type: "int", range: { min: 0, max: 65535 } },
    { id: 4, name: "Medium Int", type: "int", range: { min: -8388608, max: 8388607 } },
    { id: 5, name: "Medium Int Unsigned", type: "int", range: { min: 0, max: 16777215 } },
